...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    location = models.CharField(choices=LEVEL_CHOICES, max_length=4, verbose_name="지자체코드", default=1)
    auth = models.CharField(max_length=6, verbose_name="인증번호", null=True)
    BusinessName = models.CharField(max_length=100, verbose_name="사업자명", null=True)
    user_email = models.EmailField(max_length=128, verbose_name='사용자이메일', null=True)
    BusinessNumber = models.CharField(max_length=10, verbose_name='사업자등록번호', null=True)
...
class AuthSMS(TimeStampedModel):
    ...
    def send_sms(self):
        ...
        body = {
            ...
            "from" : "01089833328",
            "subject" : "subject",
            "content" : "[폐수일지] 인증 번호 [{}]를 입력해주세요.".format(self.auth),
            "messages" : [{"to" : self.hp}]
        }
